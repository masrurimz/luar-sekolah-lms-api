...
- [x] 3. Create course feature domain entities
...
- [x] 4. Create course feature domain schemas
...
- [x] 5. Create course feature domain errors
...
- [x] 6. Create course feature domain contracts
...
- [x] 7. Create course feature domain services
...
- [x] 8. Create course feature infrastructure repository
...
- [x] 9. Create enrollment feature infrastructure repository
...
- [x] 10. Create course feature infrastructure types
...
- [x] 11. Create get-courses application handler
...
- [x] 12. Create get-course application handler
...
- [x] 13. Create create-course application handler
...
- [x] 14. Create update-course application handler
...
- [x] 15. Create delete-course application handler
...
- [x] 16. Create enroll-course application handler
...
- [x] 17. Create get-my-courses application handler
...
- [x] 18. Update main oRPC router with course feature
  - File: apps/web/src/lib/orpc/router/index.ts
  - Import and add course feature contracts to main router
  - Ensure proper organization and documentation
  - Purpose: Integrate course feature into main API router
...
- [x] 19. Generate and apply database migrations
...
- [x] 20. Enhance OpenAPI documentation with metadata
  - File: apps/web/src/routes/courses/-domain/schemas.ts
